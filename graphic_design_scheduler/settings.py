"""
Django settings for graphic_design_scheduler project.
...
SECRET_KEY = 'django-insecure-_*3ybcp)kh^%lrido)x+q-krdrr9o#e6orlli8mj_600*z*9rw'
...
MIDDLEWARE = [
    'apps.core.middleware.VercelPathFixMiddleware',
...
ROOT_URLCONF = 'graphic_design_scheduler.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.scheduling.context_processors.business_info',
            ],
        },
    },
]

WSGI_APPLICATION = 'graphic_design_scheduler.wsgi.application'
